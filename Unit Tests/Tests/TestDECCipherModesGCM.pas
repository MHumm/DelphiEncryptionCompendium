...
// geben. M�glicherwiese ist das Padding wie es jetzt umgesetzt ist nicht ganz richtig,
// da man sonst keinen dynamischen Stream haben kann. Geh�rt vermutlich ins Done,
// aber das hat noch keinen Stream, braucht also eine �berladene Variante mit
